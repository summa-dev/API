...
async function verifyProof(pathToProof, pathToPublic) {
  ...
  if (res === true) {
    ...
    console.log(
      "Does this match the public root hash?",
      parsedPubSignals.rootHash
    );
    console.log(
      "Does this match the total assets owned by the CEX?",
      parsedPubSignals.targetSum
    );
    console.log(
      "Does this match the poseidon hash of your used ID and your balance?",
      parsedPubSignals.leafHash
    );
    console.log(
      "Does this match your balance in the exchange?",
      parsedPubSignals.leafSum
    );
