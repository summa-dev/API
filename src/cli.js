...
.argument('path/to/output/public/file', 'Path to the json file where to store the public signals of the proof')
...
program.command('verify-proof')
  ...
  .argument('<path/to/input/public/file>', "Path to the json file that stores the public signals of the proof")
