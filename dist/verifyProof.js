 ...
 */
function verifyProof(fullProof, verificationKey) {
    return __awaiter(this, void 0, void 0, function () {
        var leafHash;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    leafHash = buildLeafHash(fullProof.parsedUsername, fullProof.balance);
                    return [4 /*yield*/, snarkjs_1.groth16.verify(verificationKey, [leafHash, fullProof.rootHash, fullProof.assetsSum], fullProof.proof)];
 ...
 * @returns A leaf hash.
 */
function buildLeafHash(parsedUsername, balance) {
    var hashPreimage = [pyt_merkle_sum_tree_1.Utils.parseUsername(parsedUsername), balance];
    return (0, circomlibjs_1.poseidon)(hashPreimage);
}
